...
public class MemberDaoTest
{
    ...
    public void testFindById()
    {
        ...
        Assert.assertEquals("John Smith", member.getAccountName());
        Assert.assertEquals("john.smith@mailinator.com", member.getEmail());
        Assert.assertEquals("2125551212", member.getDeviceId());
        return;
    }
    ...
    public void testRegister()
    {
        ...
        member.setAccountName("Jane Doe");
        member.setDeviceId("2125552121");
        ...
        Assert.assertEquals("Jane Doe", newMember.getAccountName());
        Assert.assertEquals("jane.doe@mailinator.com", newMember.getEmail());
        Assert.assertEquals("2125552121", newMember.getDeviceId());
        return;
    }
